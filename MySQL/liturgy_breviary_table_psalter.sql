...
('_Apostle-1L', 1, 'திபா63:1-8'),
('_Apostle-1L', 2, 'தானி(இ)1:34-65'),
('_Apostle-1L', 3, 'திபா149'),
...
('_Church-0V', 4, 'கொலோ1:12-20'),
('_Church-1L', 1, 'திபா63:1-8'),
('_Church-1L', 2, 'தானி(இ)1:34-65'),
('_Church-1L', 3, 'திபா149'),
('_Church-5V', 1, 'திபா46'),
('_Church-5V', 2, 'திபா122'),
('_Church-5V', 3, 'திவெ19:1ஆ-2,5-7'),
('_Church-5V', 4, 'திவெ15:3-4'),
('_MartyrMany-0V', 1, 'திபா118:1-18'),
('_MartyrMany-0V', 2, 'திபா118:19-29'),
('_MartyrMany-0V', 3, '1பேது2:21-24'),
('_MartyrMany-1L', 1, 'திபா63:1-8'),
('_MartyrMany-1L', 2, 'தானி(இ)1:34-65'),
('_MartyrMany-1L', 3, 'திபா149'),
...
('_Mary-1L', 1, 'திபா63:1-8'),
('_Mary-1L', 2, 'தானி(இ)1:34-65'),
('_Mary-1L', 3, 'திபா149'),
('_Mary-5V', 1, 'திபா122'),
('_Mary-5V', 2, 'திபா127'),
...
('_Pastor-1L', 1, 'திபா63:1-8'),
('_Pastor-1L', 2, 'தானி(இ)1:34-65'),
('_Pastor-1L', 3, 'திபா149'),
('_Pastor-5V', 1, 'திபா15'),
...
('All Saints-1L', 1, 'திபா63:1-8'),
('All Saints-1L', 2, 'தானி(இ)1:34-65'),
('All Saints-1L', 3, 'திபா149'),
...
('Birth of the Blessed Virgin Mary-1L', 1, 'திபா63:1-8'),
('Birth of the Blessed Virgin Mary-1L', 2, 'தானி(இ)1:34-65'),
('Birth of the Blessed Virgin Mary-1L', 3, 'திபா149'),
('Birth of the Blessed Virgin Mary-5V', 1, 'திபா122'),
('Birth of the Blessed Virgin Mary-5V', 2, 'திபா127'),
('Birth of the Blessed Virgin Mary-5V', 3, 'எபே1:3-10'),
...
('Exaltation of the Holy Cross-1L', 1, 'திபா63:1-8'),
('Exaltation of the Holy Cross-1L', 2, 'தானி(இ)1:34-65'),
('Exaltation of the Holy Cross-1L', 3, 'திபா149'),
...
('Guardian Angels-1L', 1, 'திபா63:1-8'),
('Guardian Angels-1L', 2, 'தானி(இ)1:34-65'),
('Guardian Angels-1L', 3, 'திபா149'),
('Guardian Angels-5V', 1, 'திபா34:1-10'),
('Guardian Angels-5V', 2, 'திபா34:11-22'),
('Guardian Angels-5V', 3, 'திவெ11:17-18;12:10-12'),
('Our Lady of Sorrows-1L', 1, 'திபா63:1-8'),
('Our Lady of Sorrows-1L', 2, 'தானி(இ)1:34-65'),
('Our Lady of Sorrows-1L', 3, 'திபா149'),
('Our Lady of Sorrows-5V', 1, 'திபா122'),
('Our Lady of Sorrows-5V', 2, 'திபா127'),
('Our Lady of Sorrows-5V', 3, 'எபே1:3-10'),
('Our Lady of the Rosary-1L', 1, 'திபா63:1-8'),
('Our Lady of the Rosary-1L', 2, 'தானி(இ)1:34-65'),
('Our Lady of the Rosary-1L', 3, 'திபா149'),
('Our Lady of the Rosary-5V', 1, 'திபா122'),
('Our Lady of the Rosary-5V', 2, 'திபா127'),
('Our Lady of the Rosary-5V', 3, 'எபே1:3-10'),
('Saint Andrew the Apostle-1L', 1, 'திபா63:1-8'),
('Saint Andrew the Apostle-1L', 2, 'தானி(இ)1:34-65'),
('Saint Andrew the Apostle-1L', 3, 'திபா149'),
('Saint Andrew the Apostle-5V', 1, 'திபா116:10-19'),
('Saint Andrew the Apostle-5V', 2, 'திபா126'),
('Saint Andrew the Apostle-5V', 3, 'எபே1:3-10'),
('Saint Luke the Evangelist-1L', 1, 'திபா63:1-8'),
('Saint Luke the Evangelist-1L', 2, 'தானி(இ)1:34-65'),
('Saint Luke the Evangelist-1L', 3, 'திபா149'),
...
('Saint Martin of Tours, bishop-1L', 1, 'திபா63:1-8'),
('Saint Martin of Tours, bishop-1L', 2, 'தானி(இ)1:34-65'),
('Saint Martin of Tours, bishop-1L', 3, 'திபா149'),
...
('Saints Michael, Gabriel and Raphael, Archangels-1L', 1, 'திபா63:1-8'),
('Saints Michael, Gabriel and Raphael, Archangels-1L', 2, 'தானி(இ)1:34-65'),
('Saints Michael, Gabriel and Raphael, Archangels-1L', 3, 'திபா149'),
